...
{/* 
            {
              Object.keys(this.props.drones).map(function (key) {
                // const drone = this.drones[key]
                <Marker position={{lat: this.drones[key].curr_latitude, lng: this.drones[key].curr_longitude}} />
              })
            } */}

            {
              console.log(this.drones[5])
            }
