            ...
            {this.drones.map(drone => 
              {
                ...
                <Marker lat={drone.curr_latitude} lng={drone.curr_longitude} text="Drone"> </Marker>;
                <Marker lat={drone.dest_latitude} lng={drone.dest_longitude} text="Destination"></Marker>;
                <Polyline
                path={lineCoords}
                strokeColor="#0000FF"
                strokeOpacity={0.8}
